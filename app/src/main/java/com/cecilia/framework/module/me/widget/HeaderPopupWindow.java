...
public class HeaderPopupWindow extends PopupWindow {
    ...
    @OnClick({R.id.tv_camera,R.id.tv_choose,R.id.tv_cancel})
    ...
    public void initView(final Activity context) {
        ...
        View mView= mInflater.inflate(R.layout.layout_popup_header, null);
        ...
        this.setHeight(DensityUtil.dp2px(context, 160));
