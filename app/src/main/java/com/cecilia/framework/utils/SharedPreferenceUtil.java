...
public class SharedPreferenceUtil {
    ...
    public static boolean putString(Context context, String key, String value) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SharedPreferenceConstant.SHARED_PREFERENCE_FILE_NAME, Context.MODE_PRIVATE);
