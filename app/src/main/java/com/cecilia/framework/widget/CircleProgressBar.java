...
public class CircleProgressBar extends View {
    ...
    private int[] ints = new int[]{getResources().getColor(R.color.color_main), getResources().getColor(R.color.txt_first),
            getResources().getColor(R.color.color_assist_second)
            , getResources().getColor(R.color.black), getResources().getColor(R.color.possible_result_points)
...
//			}
    ...
    public void setColors(int[] ints) {
        this.ints = ints;
//        this.invalidate();
    }
